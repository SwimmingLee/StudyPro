...
import {create_post, read_post, update_post, delete_post, list_post} from "../controllers/postController"
...
postRouter.get(routes.post,list_post);
postRouter.post(routes.posts,create_post);
